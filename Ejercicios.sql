...
select min("rental_duration") as "Pelicula_menor_duracion", max("rental_duration") as "Pelicula_mayor_duracion"
from "film";
...
select round(avg("rental_duration"),2) as "Promedio_duracion", "rating" as "Clasificacion"
from "film"
group by "rating";
